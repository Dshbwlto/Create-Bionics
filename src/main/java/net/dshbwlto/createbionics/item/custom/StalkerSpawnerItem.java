...
public class StalkerSpawnerItem extends SpawnEggItem {
    /**
     * @param defaultType
     ...
     * @deprecated
     */
    public StalkerSpawnerItem(EntityType<? extends Mob> defaultType, int backgroundColor, int highlightColor, Properties properties) {
