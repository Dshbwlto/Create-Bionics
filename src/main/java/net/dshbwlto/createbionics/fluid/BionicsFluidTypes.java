...
public class BionicsFluidTypes {
    ...
    public static final Supplier<FluidType> MOLTEN_ANDESITE_ALLOY_FLUID_TYPE = registerFluidType("molten_andesite_alloy",
            new BaseFluidType(ANDESITE_STILL_RL, ANDESITE_FLOWING_RL, LAVA_OVERLAY_RL, 0xFFFFFFFF,
                    new Vector3f(108f / 255f, 168f / 255f, 212f / 255f),
                    FluidType.Properties.create().viscosity(100).lightLevel(2).temperature(300)));

    public static final Supplier<FluidType> MOLTEN_INDUSTRIAL_IRON_FLUID_TYPE = registerFluidType("molten_industrial_iron",
            new BaseFluidType(IRON_STILL_RL, IRON_FLOWING_RL, LAVA_OVERLAY_RL, 0xFFFFFFFF,
                    new Vector3f(108f / 255f, 168f / 255f, 212f / 255f),
                    FluidType.Properties.create().viscosity(300).lightLevel(5).temperature(300)));

    public static final Supplier<FluidType> MOLTEN_BRASS_FLUID_TYPE = registerFluidType("molten_brass",
            new BaseFluidType(BRASS_STILL_RL, BRASS_FLOWING_RL, LAVA_OVERLAY_RL, 0xFFFFFFFF,
                    new Vector3f(108f / 255f, 168f / 255f, 212f / 255f),
                    FluidType.Properties.create().viscosity(400).lightLevel(10).temperature(300)));

    public static final Supplier<FluidType> MOLTEN_NETHERITE_FLUID_TYPE = registerFluidType("molten_netherite",
            new BaseFluidType(NETHERITE_STILL_RL, NETHERITE_FLOWING_RL, LAVA_OVERLAY_RL, 0xFFFFFFFF,
                    new Vector3f(108f / 255f, 168f / 255f, 212f / 255f),
