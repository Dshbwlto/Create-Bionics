...
public class StalkerAnimations {
        ...
        public static final AnimationDefinition stalker_stay = AnimationDefinition.Builder.withLength(0.0F).looping()
                .addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(2.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
                ))
                .addAnimation("body", new AnimationChannel(AnimationChannel.Targets.POSITION,
        ...
        public static final AnimationDefinition stalker_swim = AnimationDefinition.Builder.withLength(1.0F).looping()
