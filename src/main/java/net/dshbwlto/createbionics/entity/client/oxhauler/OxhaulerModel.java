...
public class OxhaulerModel <T extends OxhaulerEntity> extends  HierarchicalModel<T>
{
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition bone3 = LegR.addOrReplaceChild("bone3", CubeListBuilder.create().texOffs(74, 179).addBox(-1.5F, -1.0F, -4.0F, 3.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.5F, 11.0F, 3.5F, -0.1745F, 0.0F, 0.0F));

        PartDefinition LegL = BackMaster.addOrReplaceChild("LegL", CubeListBuilder.create().texOffs(106, 143).addBox(-1.0F, -4.0F, -4.5F, 5.0F, 16.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.0F, 5.0F, 8.5F, 0.1745F, 0.0F, 0.0F));

        PartDefinition bone4 = LegL.addOrReplaceChild("bone4", CubeListBuilder.create().texOffs(88, 179).addBox(-1.5F, -1.0F, -4.0F, 3.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, 11.0F, 3.5F, -0.1745F, 0.0F, 0.0F));
        ...
        PartDefinition LeverL = Body.addOrReplaceChild("LeverL", CubeListBuilder.create().texOffs(50, 168).addBox(-0.5F, -12.0F, -0.5F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(50, 168).addBox(-0.5F, -10.0F, 0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(3.0F, -3.0F, -7.5F));

        PartDefinition cube_r17 = LeverL.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(66, 68).addBox(0.0F, -3.5F, -0.5F, 0.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -9.7F, 1.0F, -0.3054F, 0.0F, 0.0F));

        PartDefinition LeverR = Body.addOrReplaceChild("LeverR", CubeListBuilder.create().texOffs(50, 168).addBox(-0.5F, -12.0F, -0.5F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(50, 168).addBox(-0.5F, -10.0F, 0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-3.0F, -3.0F, -7.5F));

        PartDefinition cube_r18 = LeverR.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(66, 68).addBox(0.0F, -3.5F, -0.5F, 0.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -9.7F, 1.0F, -0.3054F, 0.0F, 0.0F));
