...
public class RepleteModel<T extends RepleteEntity> extends HierarchicalModel<T> {
    ...
    private final ModelPart leg2_l1;
    private final ModelPart leg2_l2;
    private final ModelPart leg2_l3;
    private final ModelPart leg2_r;
    private final ModelPart leg2_r1;
    private final ModelPart leg2_r2;
    private final ModelPart leg2_r3;

    private final ModelPart leg3_l;
    private final ModelPart leg3_l1;
    private final ModelPart leg3_l2;
    private final ModelPart leg3_l3;
    private final ModelPart leg3_r;
    private final ModelPart leg3_r1;
    private final ModelPart leg3_r2;
    private final ModelPart leg3_r3;
    ...
    public RepleteModel(ModelPart root) {
        ...
        this.leg_l1 = this.root.getChild("root_util").getChild("body").getChild("leg_l").getChild("leg_l1");
        this.leg_l2 = this.root.getChild("root_util").getChild("body").getChild("leg_l").getChild("leg_l2");
        this.leg_l3 = this.root.getChild("root_util").getChild("body").getChild("leg_l").getChild("leg_l3");
        this.leg_r = this.root.getChild("root_util").getChild("body").getChild("leg_r");
        this.leg_r1 = this.root.getChild("root_util").getChild("body").getChild("leg_r").getChild("leg_r1");
        this.leg_r2 = this.root.getChild("root_util").getChild("body").getChild("leg_r").getChild("leg_r2");
        this.leg_r3 = this.root.getChild("root_util").getChild("body").getChild("leg_r").getChild("leg_r3");

        this.leg2_l = this.root.getChild("root_util").getChild("body").getChild("leg2_l");
        this.leg2_l1 = this.root.getChild("root_util").getChild("body").getChild("leg2_l").getChild("leg2_l1");
        this.leg2_l2 = this.root.getChild("root_util").getChild("body").getChild("leg2_l").getChild("leg2_l2");
        this.leg2_l3 = this.root.getChild("root_util").getChild("body").getChild("leg2_l").getChild("leg2_l3");
        this.leg2_r = this.root.getChild("root_util").getChild("body").getChild("leg2_r");
        this.leg2_r1 = this.root.getChild("root_util").getChild("body").getChild("leg2_r").getChild("leg2_r1");
        this.leg2_r2 = this.root.getChild("root_util").getChild("body").getChild("leg2_r").getChild("leg2_r2");
        this.leg2_r3 = this.root.getChild("root_util").getChild("body").getChild("leg2_r").getChild("leg2_r3");

        this.leg3_l = this.root.getChild("root_util").getChild("body").getChild("leg3_l");
        this.leg3_l1 = this.root.getChild("root_util").getChild("body").getChild("leg3_l").getChild("leg3_l1");
        this.leg3_l2 = this.root.getChild("root_util").getChild("body").getChild("leg3_l").getChild("leg3_l2");
        this.leg3_l3 = this.root.getChild("root_util").getChild("body").getChild("leg3_l").getChild("leg3_l3");
        this.leg3_r = this.root.getChild("root_util").getChild("body").getChild("leg3_r");
        this.leg3_r1 = this.root.getChild("root_util").getChild("body").getChild("leg3_r").getChild("leg3_r1");
        this.leg3_r2 = this.root.getChild("root_util").getChild("body").getChild("leg3_r").getChild("leg3_r2");
        this.leg3_r3 = this.root.getChild("root_util").getChild("body").getChild("leg3_r").getChild("leg3_r3");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition leg_l = body.addOrReplaceChild("leg_l", CubeListBuilder.create(), PartPose.offset(12.0F, -6.5F, 10.0F));

        PartDefinition leg_l1 = leg_l.addOrReplaceChild("leg_l1", CubeListBuilder.create().texOffs(82, 28).addBox(-2.0F, -2.0F, -2.0F, 8.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(32, 44).addBox(6.0F, -2.5F, -2.0F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.7854F, 0.0F));

        PartDefinition leg_l1a = leg_l1.addOrReplaceChild("leg_l1a", CubeListBuilder.create().texOffs(95, 86).addBox(-2.0F, -3.0F, -3.0F, 6.0F, 6.0F, 3.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition leg_l1b = leg_l1a.addOrReplaceChild("leg_l1b", CubeListBuilder.create().texOffs(0, 165).addBox(-2.0F, -2.0F, -2.5F, 63.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition leg_l2 = leg_l.addOrReplaceChild("leg_l2", CubeListBuilder.create().texOffs(82, 28).addBox(-2.0F, -2.0F, -2.0F, 8.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(32, 44).addBox(6.0F, -2.5F, -2.0F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.7854F, 0.0F));

        PartDefinition leg_l2a = leg_l2.addOrReplaceChild("leg_l2a", CubeListBuilder.create().texOffs(95, 86).addBox(-2.0F, -3.0F, -3.0F, 6.0F, 6.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(98, 4).addBox(4.0F, -2.0F, -2.0F, 27.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(52, 0).mirror().addBox(4.0F, 2.0F, -3.0F, 27.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(52, 0).addBox(4.0F, -3.0F, -3.0F, 27.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(124, 146).addBox(31.0F, -3.0F, -3.0F, 8.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.5F, 0.0F, 1.5F, 0.0F, 0.0F, -0.6545F));

        PartDefinition leg_l2b = leg_l2a.addOrReplaceChild("leg_l2b", CubeListBuilder.create().texOffs(0, 165).addBox(-2.0F, -2.0F, -2.5F, 63.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
                .texOffs(26, 69).addBox(-2.0F, -1.0F, -1.5F, 12.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(37.0F, 0.0F, -1.5F, 0.0F, 0.0F, 1.9635F));

        PartDefinition leg_l3 = leg_l.addOrReplaceChild("leg_l3", CubeListBuilder.create().texOffs(82, 28).addBox(-2.0F, -2.0F, -2.0F, 8.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(32, 44).addBox(6.0F, -2.5F, -2.0F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.7854F, 0.0F));

        PartDefinition leg_l3a = leg_l3.addOrReplaceChild("leg_l3a", CubeListBuilder.create().texOffs(95, 86).addBox(-2.0F, -3.0F, -3.0F, 6.0F, 6.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(98, 4).addBox(4.0F, -2.0F, -2.0F, 27.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(52, 0).mirror().addBox(4.0F, 2.0F, -3.0F, 27.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(52, 0).addBox(4.0F, -3.0F, -3.0F, 27.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(124, 146).addBox(31.0F, -3.0F, -3.0F, 8.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.5F, 0.0F, 1.5F, 0.0F, 0.0F, -1.5708F));

        PartDefinition leg_l3b = leg_l3a.addOrReplaceChild("leg_l3b", CubeListBuilder.create().texOffs(0, 165).addBox(-2.0F, -2.0F, -2.5F, 63.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
                .texOffs(26, 69).addBox(-2.0F, -1.0F, -1.5F, 12.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(37.0F, 0.0F, -1.5F, 0.0F, 0.0F, 2.2689F));

        PartDefinition leg_r = body.addOrReplaceChild("leg_r", CubeListBuilder.create(), PartPose.offset(-12.0F, -6.5F, 10.0F));

        PartDefinition leg_r1 = leg_r.addOrReplaceChild("leg_r1", CubeListBuilder.create().texOffs(82, 28).addBox(-6.0F, -2.0F, -2.0F, 8.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(32, 44).addBox(-11.0F, -2.5F, -2.0F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.7854F, 0.0F));

        PartDefinition leg_r1a = leg_r1.addOrReplaceChild("leg_r1a", CubeListBuilder.create().texOffs(124, 146).mirror().addBox(-39.0F, -3.0F, -3.0F, 8.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
        ...
        PartDefinition leg_r1b = leg_r1a.addOrReplaceChild("leg_r1b", CubeListBuilder.create().texOffs(0, 165).mirror().addBox(-61.0F, -2.0F, -2.5F, 63.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
        ...
        PartDefinition leg_r2 = leg_r.addOrReplaceChild("leg_r2", CubeListBuilder.create().texOffs(82, 28).mirror().addBox(-6.0F, -2.0F, -2.0F, 8.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(32, 44).mirror().addBox(-11.0F, -2.5F, -2.0F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.7854F, 0.0F));

        PartDefinition leg_r2a = leg_r2.addOrReplaceChild("leg_r2a", CubeListBuilder.create().texOffs(95, 86).mirror().addBox(-4.0F, -3.0F, -3.0F, 6.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(98, 4).mirror().addBox(-31.0F, -2.0F, -2.0F, 27.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(52, 0).addBox(-31.0F, 2.0F, -3.0F, 27.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(52, 0).mirror().addBox(-31.0F, -3.0F, -3.0F, 27.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(124, 146).mirror().addBox(-39.0F, -3.0F, -3.0F, 8.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-8.5F, 0.0F, 1.5F, 0.0F, 0.0F, 0.6545F));

        PartDefinition leg_r2b = leg_r2a.addOrReplaceChild("leg_r2b", CubeListBuilder.create().texOffs(0, 165).mirror().addBox(-61.0F, -2.0F, -2.5F, 63.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(26, 69).mirror().addBox(-10.0F, -1.0F, -1.5F, 12.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-37.0F, 0.0F, -1.5F, 0.0F, 0.0F, -1.9635F));

        PartDefinition leg_r3 = leg_r.addOrReplaceChild("leg_r3", CubeListBuilder.create().texOffs(82, 28).mirror().addBox(-6.0F, -2.0F, -2.0F, 8.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(32, 44).mirror().addBox(-11.0F, -2.5F, -2.0F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.7854F, 0.0F));

        PartDefinition leg_r3a = leg_r3.addOrReplaceChild("leg_r3a", CubeListBuilder.create().texOffs(95, 86).mirror().addBox(-4.0F, -3.0F, -3.0F, 6.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(98, 4).mirror().addBox(-31.0F, -2.0F, -2.0F, 27.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(52, 0).addBox(-31.0F, 2.0F, -3.0F, 27.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(52, 0).mirror().addBox(-31.0F, -3.0F, -3.0F, 27.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(124, 146).mirror().addBox(-39.0F, -3.0F, -3.0F, 8.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-8.5F, 0.0F, 1.5F, 0.0F, 0.0F, 1.5708F));

        PartDefinition leg_r3b = leg_r3a.addOrReplaceChild("leg_r3b", CubeListBuilder.create().texOffs(0, 165).mirror().addBox(-61.0F, -2.0F, -2.5F, 63.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(26, 69).mirror().addBox(-10.0F, -1.0F, -1.5F, 12.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-37.0F, 0.0F, -1.5F, 0.0F, 0.0F, -2.2689F));

        PartDefinition leg2_l = body.addOrReplaceChild("leg2_l", CubeListBuilder.create(), PartPose.offset(12.0F, -3.5F, -3.0F));

        PartDefinition leg2_l1 = leg2_l.addOrReplaceChild("leg2_l1", CubeListBuilder.create().texOffs(84, 28).addBox(-2.0F, -2.0F, -2.0F, 6.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(32, 44).addBox(4.0F, -2.5F, -2.0F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition leg2_l1a = leg2_l1.addOrReplaceChild("leg2_l1a", CubeListBuilder.create().texOffs(58, 145).addBox(-2.0F, -3.0F, -3.0F, 16.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.5F, 0.0F, 1.5F, 0.0F, 0.0F, -1.0036F));

        PartDefinition leg2_l1b = leg2_l1a.addOrReplaceChild("leg2_l1b", CubeListBuilder.create().texOffs(32, 165).addBox(-2.0F, -2.0F, -2.5F, 31.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition leg2_l2 = leg2_l.addOrReplaceChild("leg2_l2", CubeListBuilder.create().texOffs(84, 28).addBox(-2.0F, -2.0F, -2.0F, 6.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(32, 44).addBox(4.0F, -2.5F, -2.0F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition leg2_l2a = leg2_l2.addOrReplaceChild("leg2_l2a", CubeListBuilder.create().texOffs(58, 145).addBox(-2.0F, -3.0F, -3.0F, 16.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.5F, 0.0F, 1.5F, 0.0F, 0.0F, 0.4363F));

        PartDefinition leg2_l2b = leg2_l2a.addOrReplaceChild("leg2_l2b", CubeListBuilder.create().texOffs(32, 165).addBox(-2.0F, -2.0F, -2.5F, 31.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
                .texOffs(26, 69).addBox(-2.0F, -1.0F, -1.5F, 12.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(12.0F, 0.0F, -1.5F, 0.0F, 0.0F, 1.0036F));

        PartDefinition leg2_l3 = leg2_l.addOrReplaceChild("leg2_l3", CubeListBuilder.create().texOffs(84, 28).addBox(-2.0F, -2.0F, -2.0F, 6.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(32, 44).addBox(4.0F, -2.5F, -2.0F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition leg2_l3a = leg2_l3.addOrReplaceChild("leg2_l3a", CubeListBuilder.create().texOffs(58, 145).addBox(-2.0F, -3.0F, -3.0F, 16.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.5F, 0.0F, 1.5F, 0.0F, 0.0F, -1.8326F));

        PartDefinition leg2_l3b = leg2_l3a.addOrReplaceChild("leg2_l3b", CubeListBuilder.create().texOffs(32, 165).addBox(-2.0F, -2.0F, -2.5F, 31.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
                .texOffs(26, 69).addBox(-2.0F, -1.0F, -1.5F, 12.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(12.0F, 0.0F, -1.5F, 0.0F, 0.0F, 2.2689F));

        PartDefinition leg2_r = body.addOrReplaceChild("leg2_r", CubeListBuilder.create(), PartPose.offset(-12.0F, -3.5F, -3.0F));

        PartDefinition leg2_r1 = leg2_r.addOrReplaceChild("leg2_r1", CubeListBuilder.create().texOffs(84, 28).addBox(-4.0F, -2.0F, -2.0F, 6.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(32, 44).addBox(-9.0F, -2.5F, -2.0F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition leg2_r1a = leg2_r1.addOrReplaceChild("leg2_r1a", CubeListBuilder.create().texOffs(58, 145).mirror().addBox(-14.0F, -3.0F, -3.0F, 16.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-6.5F, 0.0F, 1.5F, 0.0F, 0.0F, 1.0036F));

        PartDefinition leg2_r1b = leg2_r1a.addOrReplaceChild("leg2_r1b", CubeListBuilder.create().texOffs(32, 165).mirror().addBox(-29.0F, -2.0F, -2.5F, 31.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
        ...
        PartDefinition leg2_r2 = leg2_r.addOrReplaceChild("leg2_r2", CubeListBuilder.create().texOffs(84, 28).mirror().addBox(-4.0F, -2.0F, -2.0F, 6.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(32, 44).mirror().addBox(-9.0F, -2.5F, -2.0F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition leg2_r2a = leg2_r2.addOrReplaceChild("leg2_r2a", CubeListBuilder.create().texOffs(58, 145).mirror().addBox(-14.0F, -3.0F, -3.0F, 16.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-6.5F, 0.0F, 1.5F, 0.0F, 0.0F, -0.4363F));

        PartDefinition leg2_r2b = leg2_r2a.addOrReplaceChild("leg2_r2b", CubeListBuilder.create().texOffs(32, 165).mirror().addBox(-29.0F, -2.0F, -2.5F, 31.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(26, 69).mirror().addBox(-10.0F, -1.0F, -1.5F, 12.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-12.0F, 0.0F, -1.5F, 0.0F, 0.0F, -1.0036F));

        PartDefinition leg2_r3 = leg2_r.addOrReplaceChild("leg2_r3", CubeListBuilder.create().texOffs(84, 28).mirror().addBox(-4.0F, -2.0F, -2.0F, 6.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(32, 44).mirror().addBox(-9.0F, -2.5F, -2.0F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition leg2_r3a = leg2_r3.addOrReplaceChild("leg2_r3a", CubeListBuilder.create().texOffs(58, 145).mirror().addBox(-14.0F, -3.0F, -3.0F, 16.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-6.5F, 0.0F, 1.5F, 0.0F, 0.0F, 1.8326F));

        PartDefinition leg2_r3b = leg2_r3a.addOrReplaceChild("leg2_r3b", CubeListBuilder.create().texOffs(32, 165).mirror().addBox(-29.0F, -2.0F, -2.5F, 31.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(26, 69).mirror().addBox(-10.0F, -1.0F, -1.5F, 12.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-12.0F, 0.0F, -1.5F, 0.0F, 0.0F, -2.2689F));

        PartDefinition leg3_l = body.addOrReplaceChild("leg3_l", CubeListBuilder.create(), PartPose.offset(12.0F, 0.0F, -18.0F));

        PartDefinition leg3_l1 = leg3_l.addOrReplaceChild("leg3_l1", CubeListBuilder.create().texOffs(84, 28).addBox(-2.0F, -2.0F, -2.0F, 6.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(32, 44).addBox(4.0F, -2.5F, -2.0F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.3927F, 0.0F));

        PartDefinition leg3_l1a = leg3_l1.addOrReplaceChild("leg3_l1a", CubeListBuilder.create().texOffs(58, 154).addBox(-2.0F, -3.0F, -3.0F, 16.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.5F, 0.0F, 1.5F, 0.0F, 0.0F, -0.7854F));

        PartDefinition leg3_l1b = leg3_l1a.addOrReplaceChild("leg3_l1b", CubeListBuilder.create().texOffs(36, 165).addBox(-2.0F, -2.0F, -2.5F, 27.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition leg3_l2 = leg3_l.addOrReplaceChild("leg3_l2", CubeListBuilder.create().texOffs(84, 28).addBox(-2.0F, -2.0F, -2.0F, 6.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(32, 44).addBox(4.0F, -2.5F, -2.0F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.3927F, 0.0F));

        PartDefinition leg3_l2a = leg3_l2.addOrReplaceChild("leg3_l2a", CubeListBuilder.create().texOffs(58, 154).addBox(-2.0F, -3.0F, -3.0F, 16.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.5F, 0.0F, 1.5F, 0.0F, 0.0F, 0.3927F));

        PartDefinition leg3_l2b = leg3_l2a.addOrReplaceChild("leg3_l2b", CubeListBuilder.create().texOffs(36, 165).addBox(-2.0F, -2.0F, -2.5F, 27.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
                .texOffs(26, 69).addBox(-2.0F, -1.0F, -1.5F, 12.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(13.0F, 0.0F, -1.5F, 0.0F, 0.0F, 1.1345F));

        PartDefinition leg3_l3 = leg3_l.addOrReplaceChild("leg3_l3", CubeListBuilder.create().texOffs(84, 28).addBox(-2.0F, -2.0F, -2.0F, 6.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(32, 44).addBox(4.0F, -2.5F, -2.0F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.3927F, 0.0F));

        PartDefinition leg3_l3a = leg3_l3.addOrReplaceChild("leg3_l3a", CubeListBuilder.create().texOffs(58, 154).addBox(-2.0F, -3.0F, -3.0F, 16.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.5F, 0.0F, 1.5F, 0.0F, 0.0F, -1.5708F));

        PartDefinition leg3_l3b = leg3_l3a.addOrReplaceChild("leg3_l3b", CubeListBuilder.create().texOffs(36, 165).addBox(-2.0F, -2.0F, -2.5F, 27.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
                .texOffs(26, 69).addBox(-2.0F, -1.0F, -1.5F, 12.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(13.0F, 0.0F, -1.5F, 0.0F, 0.0F, 1.9548F));

        PartDefinition leg3_r = body.addOrReplaceChild("leg3_r", CubeListBuilder.create(), PartPose.offset(-12.0F, 0.0F, -18.0F));

        PartDefinition leg3_r1 = leg3_r.addOrReplaceChild("leg3_r1", CubeListBuilder.create().texOffs(84, 28).addBox(-4.0F, -2.0F, -2.0F, 6.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(32, 44).addBox(-9.0F, -2.5F, -2.0F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.3927F, 0.0F));

        PartDefinition leg3_r1a = leg3_r1.addOrReplaceChild("leg3_r1a", CubeListBuilder.create().texOffs(58, 154).mirror().addBox(-14.0F, -3.0F, -3.0F, 16.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-6.5F, 0.0F, 1.5F, 0.0F, 0.0F, 0.7854F));

        PartDefinition leg3_r1b = leg3_r1a.addOrReplaceChild("leg3_r1b", CubeListBuilder.create().texOffs(36, 165).mirror().addBox(-25.0F, -2.0F, -2.5F, 27.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
        ...
        PartDefinition leg3_r2 = leg3_r.addOrReplaceChild("leg3_r2", CubeListBuilder.create().texOffs(84, 28).mirror().addBox(-4.0F, -2.0F, -2.0F, 6.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(32, 44).mirror().addBox(-9.0F, -2.5F, -2.0F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.3927F, 0.0F));

        PartDefinition leg3_r2a = leg3_r2.addOrReplaceChild("leg3_r2a", CubeListBuilder.create().texOffs(58, 154).mirror().addBox(-14.0F, -3.0F, -3.0F, 16.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-6.5F, 0.0F, 1.5F, 0.0F, 0.0F, -0.3927F));

        PartDefinition leg3_r2b = leg3_r2a.addOrReplaceChild("leg3_r2b", CubeListBuilder.create().texOffs(36, 165).mirror().addBox(-25.0F, -2.0F, -2.5F, 27.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(26, 69).mirror().addBox(-10.0F, -1.0F, -1.5F, 12.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-13.0F, 0.0F, -1.5F, 0.0F, 0.0F, -1.1345F));

        PartDefinition leg3_r3 = leg3_r.addOrReplaceChild("leg3_r3", CubeListBuilder.create().texOffs(84, 28).mirror().addBox(-4.0F, -2.0F, -2.0F, 6.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(32, 44).mirror().addBox(-9.0F, -2.5F, -2.0F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.3927F, 0.0F));

        PartDefinition leg3_r3a = leg3_r3.addOrReplaceChild("leg3_r3a", CubeListBuilder.create().texOffs(58, 154).mirror().addBox(-14.0F, -3.0F, -3.0F, 16.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-6.5F, 0.0F, 1.5F, 0.0F, 0.0F, 1.5708F));

        PartDefinition leg3_r3b = leg3_r3a.addOrReplaceChild("leg3_r3b", CubeListBuilder.create().texOffs(36, 165).mirror().addBox(-25.0F, -2.0F, -2.5F, 27.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(26, 69).mirror().addBox(-10.0F, -1.0F, -1.5F, 12.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-13.0F, 0.0F, -1.5F, 0.0F, 0.0F, -1.9548F));
        ...
        PartDefinition tank_single = tank.addOrReplaceChild("tank_single", CubeListBuilder.create().texOffs(216, 112).addBox(15.0F, -8.0F, -16.0F, 0.0F, 8.0F, 12.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(12, 40).mirror().addBox(-16.0F, -8.0F, -16.0F, 12.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(216, 124).mirror().addBox(-16.0F, -8.0F, -15.0F, 12.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
                ...
                .texOffs(216, 112).mirror().addBox(-15.0F, -8.0F, -16.0F, 0.0F, 8.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false)
                ...
                .texOffs(228, 124).addBox(-16.0F, -8.0F, 15.0F, 12.0F, 8.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(11, 39).mirror().addBox(-4.0F, -8.0F, 15.0F, 0.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(228, 112).mirror().addBox(-16.0F, -8.0F, 4.0F, 0.0F, 8.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(0, 28).mirror().addBox(-15.0F, -8.0F, 4.0F, 0.0F, 8.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(11, 40).mirror().addBox(-16.0F, -8.0F, 4.0F, 1.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(216, 124).addBox(4.0F, -8.0F, 16.0F, 12.0F, 8.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(12, 40).addBox(4.0F, -8.0F, 15.0F, 12.0F, 8.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(0, 28).addBox(16.0F, -8.0F, 4.0F, 0.0F, 8.0F, 12.0F, new CubeDeformation(0.0F))
                .texOffs(0, 28).addBox(15.0F, -8.0F, 4.0F, 0.0F, 8.0F, 12.0F, new CubeDeformation(0.0F))
                .texOffs(11, 40).addBox(15.0F, -8.0F, 4.0F, 1.0F, 8.0F, 0.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition tank_3 = tank.addOrReplaceChild("tank_3", CubeListBuilder.create().texOffs(12, 0).addBox(15.0F, -16.0F, -16.0F, 0.0F, 16.0F, 12.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(216, 96).addBox(4.0F, -16.0F, -15.0F, 12.0F, 16.0F, 0.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 12).addBox(-16.0F, -16.0F, -15.0F, 12.0F, 16.0F, 0.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(216, 84).addBox(-15.0F, -16.0F, -16.0F, 0.0F, 16.0F, 12.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 0).addBox(-15.0F, -16.0F, 4.0F, 0.0F, 16.0F, 12.0F, new CubeDeformation(0.0F))
                .texOffs(11, 12).mirror().addBox(-16.0F, -16.0F, 4.0F, 1.0F, 16.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
        ...
        PartDefinition tank_4 = tank.addOrReplaceChild("tank_4", CubeListBuilder.create().texOffs(12, 0).addBox(15.0F, -16.0F, -16.0F, 0.0F, 16.0F, 12.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(11, 11).mirror().addBox(-4.0F, -16.0F, 15.0F, 0.0F, 16.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(228, 84).addBox(-16.0F, -16.0F, 4.0F, 0.0F, 16.0F, 12.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).mirror().addBox(-15.0F, -16.0F, 4.0F, 0.0F, 16.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(11, 12).mirror().addBox(-16.0F, -16.0F, 4.0F, 1.0F, 16.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(216, 96).addBox(4.0F, -16.0F, 16.0F, 12.0F, 16.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(12, 12).addBox(4.0F, -16.0F, 15.0F, 12.0F, 16.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(16.0F, -16.0F, 4.0F, 0.0F, 16.0F, 12.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition tank_bottom = tank.addOrReplaceChild("tank_bottom", CubeListBuilder.create().texOffs(12, 16).addBox(15.0F, -12.0F, -16.0F, 0.0F, 12.0F, 12.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(216, 112).addBox(4.0F, -12.0F, -15.0F, 12.0F, 12.0F, 0.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 28).addBox(-16.0F, -12.0F, -15.0F, 12.0F, 12.0F, 0.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(216, 100).addBox(-15.0F, -12.0F, -16.0F, 0.0F, 12.0F, 12.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(228, 100).addBox(-16.0F, -12.0F, 4.0F, 0.0F, 12.0F, 12.0F, new CubeDeformation(0.0F))
                .texOffs(0, 16).addBox(-15.0F, -12.0F, 4.0F, 0.0F, 12.0F, 12.0F, new CubeDeformation(0.0F))
                .texOffs(11, 28).mirror().addBox(-16.0F, -12.0F, 4.0F, 1.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
        ...
        PartDefinition tank_top = tank_cap.addOrReplaceChild("tank_top", CubeListBuilder.create().texOffs(12, -12).addBox(15.0F, -8.0F, -16.0F, 0.0F, 12.0F, 12.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(216, 84).addBox(4.0F, -8.0F, -15.0F, 12.0F, 12.0F, 0.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 0).addBox(-16.0F, -8.0F, -15.0F, 12.0F, 12.0F, 0.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(216, 72).mirror().addBox(-15.0F, -8.0F, -16.0F, 0.0F, 12.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false)
                ...
                .texOffs(0, -12).addBox(-15.0F, -8.0F, 4.0F, 0.0F, 12.0F, 12.0F, new CubeDeformation(0.0F))
                .texOffs(11, 0).mirror().addBox(-16.0F, -8.0F, 4.0F, 1.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
    ...
    public void setupAnim(RepleteEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        leg_r1.visible = entity.leg_r1.isColliding() && !entity.leg_r2.isColliding();
        leg_r2.visible = !entity.leg_r1.isColliding();
        leg_r3.visible = entity.leg_r1.isColliding() && entity.leg_r2.isColliding();

        leg2_l1.visible = entity.leg2_l1.isColliding() && !entity.leg2_l2.isColliding();
        leg2_l2.visible = !entity.leg2_l1.isColliding();
        leg2_l3.visible = entity.leg2_l1.isColliding() && entity.leg2_l2.isColliding();
        leg2_r1.visible = entity.leg2_r1.isColliding() && !entity.leg2_r2.isColliding();
        leg2_r2.visible = !entity.leg2_r1.isColliding();
        leg2_r3.visible = entity.leg2_r1.isColliding() && entity.leg2_r2.isColliding();

        leg3_l1.visible = entity.leg3_l1.isColliding() && !entity.leg3_l2.isColliding();
        leg3_l2.visible = !entity.leg3_l1.isColliding();
        leg3_l3.visible = entity.leg3_l1.isColliding() && entity.leg3_l2.isColliding();
        leg3_r1.visible = entity.leg3_r1.isColliding() && !entity.leg3_r2.isColliding();
