...
public class RepleteModel<T extends RepleteEntity> extends HierarchicalModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition tank = root_util.addOrReplaceChild("tank", CubeListBuilder.create().texOffs(120, 145).addBox(-16.0F, -4.0F, 0.0F, 32.0F, 4.0F, 32.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(296, 43).addBox(-10.0F, 0.0F, 9.0F, 20.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -20.0F, 11.0F));
        ...
        PartDefinition tank_single = tank.addOrReplaceChild("tank_single", CubeListBuilder.create().texOffs(36, 46).addBox(15.0F, -8.0F, -16.0F, 0.0F, 8.0F, 12.0F, new CubeDeformation(0.0F))
                .texOffs(35, 58).addBox(15.0F, -8.0F, -4.0F, 1.0F, 8.0F, 0.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(35, 57).addBox(4.0F, -8.0F, -16.0F, 0.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(35, 57).mirror().addBox(-4.0F, -8.0F, -16.0F, 0.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                ...
                .texOffs(35, 58).mirror().addBox(-16.0F, -8.0F, -4.0F, 1.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(36, 58).mirror().addBox(-16.0F, -8.0F, 16.0F, 12.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(36, 58).mirror().addBox(-16.0F, -8.0F, 15.0F, 12.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(35, 57).mirror().addBox(-4.0F, -8.0F, 15.0F, 0.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                ...
                .texOffs(35, 58).addBox(15.0F, -8.0F, 4.0F, 1.0F, 8.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(35, 57).addBox(4.0F, -8.0F, 15.0F, 0.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition tank_3 = tank.addOrReplaceChild("tank_3", CubeListBuilder.create().texOffs(36, 6).addBox(15.0F, -16.0F, -16.0F, 0.0F, 16.0F, 12.0F, new CubeDeformation(0.0F))
                .texOffs(35, 18).addBox(15.0F, -16.0F, -4.0F, 1.0F, 16.0F, 0.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(35, 17).addBox(4.0F, -16.0F, -16.0F, 0.0F, 16.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(35, 17).mirror().addBox(-4.0F, -16.0F, -16.0F, 0.0F, 16.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                ...
                .texOffs(35, 18).mirror().addBox(-16.0F, -16.0F, -4.0F, 1.0F, 16.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(36, 18).mirror().addBox(-16.0F, -16.0F, 16.0F, 12.0F, 16.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(36, 18).mirror().addBox(-16.0F, -16.0F, 15.0F, 12.0F, 16.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(35, 17).mirror().addBox(-4.0F, -16.0F, 15.0F, 0.0F, 16.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                ...
                .texOffs(35, 18).addBox(15.0F, -16.0F, 4.0F, 1.0F, 16.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(35, 17).addBox(4.0F, -16.0F, 15.0F, 0.0F, 16.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition tank_bottom = tank.addOrReplaceChild("tank_bottom", CubeListBuilder.create().texOffs(36, 24).addBox(15.0F, -12.0F, -16.0F, 0.0F, 12.0F, 12.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(36, 36).addBox(4.0F, -12.0F, 16.0F, 12.0F, 12.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(36, 36).addBox(4.0F, -12.0F, 15.0F, 12.0F, 12.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(0, 24).addBox(16.0F, -12.0F, 4.0F, 0.0F, 12.0F, 12.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition tank_cap = tank.addOrReplaceChild("tank_cap", CubeListBuilder.create().texOffs(160, 0).addBox(-16.0F, 4.0F, -16.0F, 32.0F, 4.0F, 32.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -84.0F, 16.0F));
        ...
        PartDefinition tank_top = tank_cap.addOrReplaceChild("tank_top", CubeListBuilder.create().texOffs(36, -8).addBox(15.0F, -8.0F, -16.0F, 0.0F, 12.0F, 12.0F, new CubeDeformation(0.0F))
                .texOffs(35, 4).addBox(15.0F, -8.0F, -4.0F, 1.0F, 12.0F, 0.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(35, 3).addBox(4.0F, -8.0F, -16.0F, 0.0F, 12.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(35, 3).mirror().addBox(-4.0F, -8.0F, -16.0F, 0.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                ...
                .texOffs(35, 4).mirror().addBox(-16.0F, -8.0F, -4.0F, 1.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(36, 4).mirror().addBox(-16.0F, -8.0F, 16.0F, 12.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(36, 4).mirror().addBox(-16.0F, -8.0F, 15.0F, 12.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(35, 3).mirror().addBox(-4.0F, -8.0F, 15.0F, 0.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                ...
                .texOffs(35, 4).addBox(15.0F, -8.0F, 4.0F, 1.0F, 12.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(35, 3).addBox(4.0F, -8.0F, 15.0F, 0.0F, 12.0F, 1.0F, new CubeDeformation(0.0F))
