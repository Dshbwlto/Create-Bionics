...
public class RepleteModel<T extends RepleteEntity> extends HierarchicalModel<T> {
    ...
    public RepleteModel(ModelPart root) {
        ...
        this.dial = this.root.getChild("root_util").getChild("body").getChild("dial");
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition body = root_util.addOrReplaceChild("body", CubeListBuilder.create().texOffs(146, 92).addBox(-14.0F, -10.5F, 7.0F, 28.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(146, 92).addBox(-14.0F, -4.0F, -21.0F, 28.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(96, 147).addBox(-5.0F, -19.15F, -13.9F, 10.0F, 10.0F, 8.0F, new CubeDeformation(0.0F))
                .texOffs(0, 129).addBox(-5.0F, -19.15F, -13.4F, 10.0F, 10.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(1, 138).addBox(-4.0F, -18.15F, -13.9F, 8.0F, 0.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(1, 138).addBox(-4.0F, -11.15F, -13.9F, 8.0F, 0.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(9, 128).addBox(4.0F, -18.15F, -13.9F, 0.0F, 9.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(9, 128).addBox(-4.0F, -18.15F, -13.9F, 0.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition cube_r3 = body.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(75, 73).addBox(-2.0F, 10.0F, -56.0F, 4.0F, 9.0F, 63.0F, new CubeDeformation(0.0F))
                .texOffs(1, 106).mirror().addBox(9.5F, 9.5F, -42.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
        ...
        PartDefinition cube_r6 = carapace.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(146, 122).addBox(3.0F, 0.0F, 3.0F, 6.0F, 2.0F, 12.0F, new CubeDeformation(0.0F))
                .texOffs(146, 122).addBox(5.0F, 0.0F, -29.5F, 6.0F, 2.0F, 12.0F, new CubeDeformation(0.0F))
                .texOffs(0, 9).addBox(0.0F, 0.0F, -33.0F, 13.0F, 4.0F, 56.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.0F, -23.0F, 0.0F, 0.0F, 0.1745F));

        PartDefinition cube_r7 = carapace.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(146, 122).mirror().addBox(-9.0F, 0.0F, 3.0F, 6.0F, 2.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(146, 122).mirror().addBox(-11.0F, 0.0F, -29.5F, 6.0F, 2.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(0, 69).addBox(-13.0F, 0.0F, -33.001F, 13.0F, 4.0F, 56.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.0F, -23.0F, 0.0F, 0.0F, -0.1745F));
        ...
        PartDefinition cube_r8 = stand.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(0, 69).addBox(-1.0F, 19.0F, -22.0F, 2.0F, 14.0F, 19.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.2182F, 0.0F, 0.0F));
        ...
        PartDefinition leg_l2 = leg_l.addOrReplaceChild("leg_l2", CubeListBuilder.create().texOffs(95, 86).addBox(-2.0F, -3.0F, -3.0F, 6.0F, 6.0F, 3.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(52, 0).addBox(4.0F, 2.0F, -3.0F, 27.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition leg_r2 = leg_r.addOrReplaceChild("leg_r2", CubeListBuilder.create().texOffs(124, 146).mirror().addBox(-39.0F, -3.0F, -3.0F, 8.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
                ...
                .texOffs(52, 0).addBox(-31.0F, -3.0F, -3.0F, 27.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition cube_r9 = pump_case.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(146, 73).mirror().addBox(-4.0F, 0.0F, 0.0F, 18.0F, 12.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-5.0F, -10.5F, 13.95F, -1.5708F, 0.0F, 0.0F));

        PartDefinition cube_r10 = pump_case.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(32, 75).addBox(-5.0F, -3.2164F, -6.2263F, 10.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.25F, 17.75F, -1.5708F, 0.0F, 0.0F));

        PartDefinition pump = pump_case.addOrReplaceChild("pump", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition cube_r11 = pump.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(82, 110).addBox(-6.0F, -16.2164F, -6.9763F, 12.0F, 3.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.5708F, 0.0F, 0.0F));

        PartDefinition cube_r12 = pump.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(82, 110).addBox(-6.0F, -3.0F, -6.0F, 12.0F, 3.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.0F, 0.0F, -1.5708F, 0.0F, 0.0F));

        PartDefinition gear = pump.addOrReplaceChild("gear", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition cube_r13 = gear.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(82, 73).addBox(-9.0F, -13.0F, -1.5F, 18.0F, 10.0F, 3.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition cube_r14 = gear.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(82, 73).addBox(-9.0F, -13.0F, -1.5F, 18.0F, 10.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.5708F, 0.0F, 3.1416F));

        PartDefinition cube_r15 = gear.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(82, 73).addBox(-9.0F, -13.0F, -1.5F, 18.0F, 10.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.5708F, 0.0F, -1.5708F));

        PartDefinition cube_r16 = gear.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(82, 73).addBox(-9.0F, -13.0F, -1.5F, 18.0F, 10.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.5708F, 0.0F, 2.3562F));

        PartDefinition cube_r17 = gear.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(82, 36).addBox(-7.0F, -12.9F, -2.5F, 14.0F, 10.0F, 5.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition cube_r18 = gear.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(82, 36).addBox(-7.0F, -12.9F, -2.5F, 14.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.5708F, 0.0F, 1.9635F));

        PartDefinition cube_r19 = gear.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(82, 36).addBox(-7.0F, -12.9F, -2.5F, 14.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.5708F, 0.0F, -0.3927F));

        PartDefinition cube_r20 = gear.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(82, 36).addBox(-7.0F, -12.9F, -2.5F, 14.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.5708F, 0.0F, -2.7489F));

        PartDefinition cube_r21 = gear.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(82, 36).addBox(-7.0F, -12.9F, -2.5F, 14.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.5708F, 0.0F, -1.1781F));

        PartDefinition dial = body.addOrReplaceChild("dial", CubeListBuilder.create().texOffs(0, 139).addBox(-0.5F, -6.0F, 1.35F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, -11.65F, -15.0F));
        ...
        PartDefinition cube_r22 = tank.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(38, 105).mirror().addBox(0.0F, -2.0F, -4.0F, 2.0F, 13.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.0F, 4.0F, 16.0F, -0.6109F, 0.0F, 0.0F));
        ...
        PartDefinition tank_3 = tank.addOrReplaceChild("tank_3", CubeListBuilder.create().texOffs(12, 0).addBox(15.0F, -16.0F, -16.0F, 0.0F, 16.0F, 12.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(12, 0).mirror().addBox(-16.0F, -16.0F, -16.0F, 0.0F, 16.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false)
                ...
                .texOffs(12, 0).mirror().addBox(-15.0F, -16.0F, 4.0F, 0.0F, 16.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(11, 12).mirror().addBox(-16.0F, -16.0F, 4.0F, 1.0F, 16.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(12, 12).addBox(4.0F, -16.0F, 16.0F, 12.0F, 16.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(12, 12).addBox(4.0F, -16.0F, 15.0F, 12.0F, 16.0F, 0.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition tank_bottom = tank.addOrReplaceChild("tank_bottom", CubeListBuilder.create().texOffs(12, 16).addBox(15.0F, -12.0F, -16.0F, 0.0F, 12.0F, 12.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(12, 16).mirror().addBox(-16.0F, -12.0F, -16.0F, 0.0F, 12.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false)
                ...
                .texOffs(12, 16).mirror().addBox(-15.0F, -12.0F, 4.0F, 0.0F, 12.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(23, 28).mirror().addBox(-16.0F, -12.0F, 4.0F, 1.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(12, 28).addBox(4.0F, -12.0F, 16.0F, 12.0F, 12.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(12, 28).addBox(4.0F, -12.0F, 15.0F, 12.0F, 12.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(0, 16).mirror().addBox(16.0F, -12.0F, 4.0F, 0.0F, 12.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false)
        ...
        PartDefinition tank_top = tank_cap.addOrReplaceChild("tank_top", CubeListBuilder.create().texOffs(12, -12).addBox(15.0F, -8.0F, -16.0F, 0.0F, 12.0F, 12.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(12, -12).mirror().addBox(-16.0F, -8.0F, -16.0F, 0.0F, 12.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false)
                ...
                .texOffs(12, -12).mirror().addBox(-15.0F, -8.0F, 4.0F, 0.0F, 12.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(11, 0).mirror().addBox(-16.0F, -8.0F, 4.0F, 1.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(12, 0).addBox(4.0F, -8.0F, 16.0F, 12.0F, 12.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(12, 0).addBox(4.0F, -8.0F, 15.0F, 12.0F, 12.0F, 0.0F, new CubeDeformation(0.0F))
    ...
    public void setupAnim(RepleteEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        dial.zRot = (float) entity.getFuel() / 10000 * (Mth.PI / 2) - Mth.PI / 2;
