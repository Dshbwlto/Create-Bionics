package net.dshbwlto.createbionics.entity.ai;
...
public abstract class AnimalFollowOwnerGoal extends FollowOwnerGoal {
    ...
    private OrganEntity tameable;

    public AnimalFollowOwnerGoal(OrganEntity tameable, double speed, float minDist, float maxDist, boolean teleportToLeaves) {
